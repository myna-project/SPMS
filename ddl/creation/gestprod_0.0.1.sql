...
ALTER TABLE working_phases ADD CONSTRAINT user_id__users_fkey FOREIGN KEY (user_id) REFERENCES users(id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION;
...
CREATE TABLE validation_phases (
    ...
    start_time timestamp with time zone,
    end_time timestamp with time zone,
    humidity_finished_product double precision,
    density_finished_product double precision,
